        ...
        <div class="row dasboard justify-content-center align-items-center">
            <div class="col-md-4 col-12">
                <a class="row" href="{{ route('project.index','new') }}">
                    <div class="col-4">
                        <img class="icons" src="{{ assets('images/new.png') }}" alt=""></img>
                    </div>
                    <div class="col-8">
            ...
            <div class="col-md-4 col-12">
                <a class="row" href="{{ route('project.index','on-going') }}">
                    <div class="col-4">
                        <img class="icons" src="{{ assets('images/on-going.png') }}" alt=""></img>
                    </div>
                    <div class="col-8">
            ...
            <div class="col-md-4 col-12">
                <a class="row" href="{{ route('project.index','completed') }}">
                    <div class="col-4">
                        <img class="icons" src="{{ assets('images/completed.png') }}" alt=""></img>
                    </div>
                    <div class="col-8">
                        <h2>on going projects</h2>
                        <div class="description">
